  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#index.php?page_name=pos">Point Of Sale </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.php?page_name=sign-in">Sign-in</a>
          </li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="index.php?page_name=Profile-settings">Profile settings</a></li>
